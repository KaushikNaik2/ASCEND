...
- `core/`: Cross-cutting concerns like security and configuration.
- `services/`: Business logic (PDF processing, LLM orchestration).
...
- [ ] Implement database persistence for extracted syllabus data.
