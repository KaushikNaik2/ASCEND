...
import { Copy, Check, ChevronDown, BookOpen, Clock, Calendar, Loader2, Sparkles } from 'lucide-react';
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm transition-colors ${isExpanded ? 'bg-blue-500/20 text-blue-400' : 'bg-white/5 text-slate-400 group-hover:bg-white/10 group-hover:text-slate-300'
                    }`}>
                    {mod.module_number}
                  </div>
